...
// Image constants
const HERO_IMAGES = [
  "/images/rolex_gold_daydate_1777619061428.png",
  "/images/seiko_new_luxury.png",
  "/images/luxury_sneakers_black_1777619390059.png",
  "/images/baggy_jeans_dark_1777619408317.png",
  "/images/aesthetic_outfit_mood_1777619427376.png"
];
...
const PRODUCTS = [
  ...
  { id: 1, category: "Watches" as Category, brand: "Rolex Style", name: "Datejust Ebony Mod", price: 999, images: ["/images/rolex_classic_dark_1777619040163.png", "/images/rolex_gold_daydate_1777619061428.png"], description: "Fluted bezel, Jubilee bracelet, precision automatic.", specs: ["41mm Case", "Sapphire Glass", "Date Display"] },
  { id: 2, category: "Watches" as Category, brand: "Rolex Style", name: "Day-Date Presidential Gold", price: 999, images: ["/images/rolex_gold_daydate_1777619061428.png", "/images/rolex_classic_dark_1777619040163.png"], description: "Full gold finish, the peak of presidential luxury.", specs: ["36mm Case", "Gold-Plated Steel", "Day-Date Window"] },
  { id: 3, category: "Watches" as Category, brand: "Rolex Style", name: "Submariner Hulk Edition", price: 999, images: ["/images/rolex_submariner_hulk_1777619078004.png", "/images/rolex_pepsi_gmt_1777619093643.png"], description: "Deep green sunburst dial with matching ceramic bezel.", specs: ["40mm Case", "Ceramic Insert", "Oyster Braclet"] },
  { id: 4, category: "Watches" as Category, brand: "Rolex Style", name: "GMT Master II Pepsi", price: 999, images: ["/images/rolex_pepsi_gmt_1777619093643.png", "/images/rolex_submariner_hulk_1777619078004.png"], description: "Iconic red and blue bezel for the modern traveler.", specs: ["40mm Case", "Jubilee Band", "GMT Movement"] },
  { id: 5, category: "Watches" as Category, brand: "Rolex Style", name: "Yacht-Master Oysterflex", price: 999, images: ["/images/rolex_yacht_master_rose_1777619110502.png", "/images/rolex_classic_dark_1777619040163.png"], description: "Rose gold luxury paired with a sporty matte black strap.", specs: ["40mm Case", "Matte Ceramic", "Flexible Strap"] },
  { id: 6, category: "Watches" as Category, brand: "Seiko Style", name: "Prospex Turtle Stealth", price: 999, images: ["/images/seiko_prospex_turtle_1777619127382.png", "/images/seiko_alpinist_green_1777619144101.png"], description: "Rugged professional diver with the classic cushion case.", specs: ["44mm Case", "NH35 Automatic", "High Lume"] },
  { id: 7, category: "Watches" as Category, brand: "Seiko Style", name: "Alpinist Emerald Gold", price: 999, images: ["/images/seiko_alpinist_green_1777619144101.png", "/images/seiko_prospex_turtle_1777619127382.png"], description: "Internal compass bezel and signature green dial.", specs: ["38mm Case", "Leather Strap", "Sunburst Finish"] },
  { id: 8, category: "Watches" as Category, brand: "Seiko Style", name: "Presage Cocktail Moon", price: 999, images: ["/images/seiko_presage_cocktail_1777619160466.png", "/images/seiko_5_sports_stealth_1777619177377.png"], description: "Elegant radiating dial inspired by the Blue Moon cocktail.", specs: ["40mm Case", "Honed Indices", "Silver Case"] },
  { id: 9, category: "Watches" as Category, brand: "Seiko Style", name: "5 Sports Dark Stealth", price: 999, images: ["/images/seiko_5_sports_stealth_1777619177377.png", "/images/seiko_presage_cocktail_1777619160466.png"], description: "All-black tactical mod with a minimalist aesthetic.", specs: ["42mm Case", "PVD Finish", "Dark Grey Lume"] },
  { id: 10, category: "Watches" as Category, brand: "Seiko Style", name: "King Seiko Heritage", price: 999, images: ["/images/seiko_king_vintage_1777619196033.png", "/images/seiko_alpinist_green_1777619144101.png"], description: "A sharp, vintage-inspired dress watch with angular lugs.", specs: ["37mm Case", "Linear Dial", "Classic Leather"] },
  { id: 20, category: "Watches" as Category, brand: "Seiko Style", name: "Seiko Mod 'Grand' Edition", price: 999, images: ["/images/seiko_new_luxury.png", "/images/seiko_king_vintage_1777619196033.png"], description: "Premium sunburst dial with high-polish indices and precision modded movement.", specs: ["40mm Case", "Grand Style Dial", "Stainless Steel"] },
  
  // SHOES
  { id: 11, category: "Shoes" as Category, brand: "Honey's Elite", name: "Phantom Leather Sneakers", price: 999, images: ["/images/luxury_sneakers_black_1777619390059.png", "/images/luxury_sneakers_black_1777619390059.png"], description: "Handcrafted matte black leather for the ultimate minimal look.", specs: ["Calfskin Leather", "Italian Stitching"] },
  { id: 12, category: "Shoes" as Category, brand: "Honey's Elite", name: "Onyx Street Runner", price: 999, images: ["/images/luxury_sneakers_black_1777619390059.png", "/images/luxury_sneakers_black_1777619390059.png"], description: "Proprietary foam technology meeting high-end fashion design.", specs: ["Comfort Insole", "Breathable Mesh"] },
  { id: 13, category: "Shoes" as Category, brand: "Honey's Elite", name: "Stealth Hi-Top", price: 999, images: ["/images/luxury_sneakers_black_1777619390059.png", "/images/luxury_sneakers_black_1777619390059.png"], description: "The iconic hi-top silhouette redefined in premium materials.", specs: ["Premium Suede", "Ankle Support"] },
  
  // JEANS
  { id: 14, category: "Baggy Jeans" as Category, brand: "Urban Mood", name: "Midnight Baggy Denim", price: 999, images: ["/images/baggy_jeans_dark_1777619408317.png", "/images/baggy_jeans_dark_1777619408317.png"], description: "Perfectly oversized with a structured architecture.", specs: ["14oz Denim", "Deep Charcoal Wash"] },
  { id: 15, category: "Baggy Jeans" as Category, brand: "Urban Mood", name: "Washed Slate Oversized", price: 999, images: ["/images/baggy_jeans_dark_1777619408317.png", "/images/baggy_jeans_dark_1777619408317.png"], description: "A relaxed drape that defines the modern streetwear look.", specs: ["Relaxed Taper", "Reinforced Hem"] },
  { id: 16, category: "Baggy Jeans" as Category, brand: "Urban Mood", name: "Tactical Denim Baggy", price: 999, images: ["/images/baggy_jeans_dark_1777619408317.png", "/images/baggy_jeans_dark_1777619408317.png"], description: "Combining utility aesthetics with classic baggy fits.", specs: ["Multi-pocket", "YKK Hardware"] },

  // OUTFITS
  { id: 17, category: "Aesthetic Outfits" as Category, brand: "Honeys Design", name: "Shadowbox Hoodie Set", price: 999, images: ["/images/aesthetic_outfit_mood_1777619427376.png", "/images/aesthetic_outfit_mood_1777619427376.png"], description: "The full dark ensemble: Oversized hoodie and tech cargos.", specs: ["Heavyweight Cotton", "Relaxed Fit"] },
  { id: 18, category: "Aesthetic Outfits" as Category, brand: "Honeys Design", name: "Minimalist Lounge Ensemble", price: 999, images: ["/images/aesthetic_outfit_mood_1777619427376.png", "/images/aesthetic_outfit_mood_1777619427376.png"], description: "Luxury loungewear designed for high-end aesthetic comfort.", specs: ["Silk-touch Fabric", "Clean Silhouettes"] }
];
